...
def key_pressure(key):
    try:
        ...
        print(
         ...
         \t\t   {first}\n   
          \t    <<<  \033[1m \033[92m {menu_select_options[menu_index_option][0]} \033[92m \033[0m {Fore.WHITE}  >>>  \n
           \t\t   {second}   
        ...
        print(
            ...
            \t     <<< {Fore.WHITE} \033[92m {menu_select_options[menu_index_option][0]} \033[92m {Fore.WHITE} >>> \n
            \t\t   {second}  
